...
in which we will include all possible combinations of the values selected for $d$ and $\kappa$. In that way, we will be able to extract the paired values of $d$ and $\kappa$ (i.e., each row in the data frame will correspond to one combination of the values paired for $d$ and $\kappa$) and use them for subsequent analyses:
